...
# from app.employees.models import EmployeeSchedule, EmployeeGroupMembership
# from app.schedules.models import BREAK_HOURS
# from app.attendance.models import (
#     Attendance, AttendanceStatus, AttendanceLog,
#     Holiday
# )
...
#     from app.attendance.models import OvertimeRequest as _OTR
#     existing_approved_ot = _OTR.objects.filter(
...
# # def _get_ut_reason(is_long_shift, is_24hr_shift, has_schedule, pairs, actual_break):
# #     if is_long_shift and not is_24hr_shift:
# #         return "Employee did not complete the required hours for the shift."
# #     elif has_schedule and len(pairs) > 1 and actual_break > BREAK_HOURS:
# #         return "Employee left early during the first half of the shift."
# #     return "Employee left before the shift end time."
