...
# from app.attendance.compute.core import compute_attendance_from_logs
...
# class ApprovalRecordView(LoginRequiredMixin, View):

#     def get(self, request):
#         dept_filter = get_dept_queryset_filter(request)
#         if dept_filter is None:
#             return render(request, 'dashboard/approvals/approval-records.html', {'dept_warning': True})
...
#         return render(request, 'dashboard/approvals/approval-records.html', {
