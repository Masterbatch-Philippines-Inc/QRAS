...
ADMIN_EMAIL    = 'mbpi.itsupport@gmail.com'
...
class Command(BaseCommand):
    ...
    def seed_departments(self):
        from apps.qras.models.access import Department
    ...
    def seed_positions(self):
        from apps.qras.models.access import Department, Position
    ...
    def seed_roles_and_permissions(self):
        from apps.qras.models.access import Role, Module, RolePermission
    ...
    def seed_admin_account(self):
        from apps.qras.models.access import Role
    ...
    def seed_notify_trigger(self):
        with connection.cursor() as cursor:
            ...
            cursor.execute("""
                DROP TRIGGER IF EXISTS attendance_log_notify ON attendance_logs;
