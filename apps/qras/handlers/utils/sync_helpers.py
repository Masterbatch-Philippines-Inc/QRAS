...
def sync_all_models(stdout, style):
    from apps.qras.models.auth import Role
    from apps.qras.models.access import Module, RolePermission, Department, Position
    ...
    from apps.qras.models.scanner import ScanCapture
