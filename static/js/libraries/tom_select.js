...
!(function (e, t) {
      ...
      i(
        c(e).map((e) =>
          ((e, t = 1) => {
            let i = 0;
            return (
              (e = e.map((e) => (u[e] && (i += e.length), u[e] || e))),
              i >= t ? s(e) : ""
            );
          })(e, t),
        ),
  ...
  class C {
    ...
    clone(e, t) {
      ...
      let o = t.substr.substring(0, e - n.start),
        r = o.length;
      return (
        i.add({ start: n.start, end: n.start + r, length: r, substr: o }),
        i
      );
    }
  }
      ...
      for (let s = 0; s < e.length; s++) {
        ...
        for (const e of i) {
          ...
          if (!t || 1 == t.length || t.end <= s)
            if (r) {
              const t = r.length;
              (e.add({ start: s, end: s + t, length: t, substr: r }),
                a.add("1"));
            } else
              (e.add({ start: s, end: s + 1, length: 1, substr: o }),
                a.add("2"));
          else if (r) {
            let i = e.clone(s, t);
            const n = r.length;
      ...
      return i.length
        ? function (e, t) {
            ...
            for (let o of i) {
              if (
                ((n = o.field),
                (s = ("desc" === o.direction ? -1 : 1) * E(r(n, e), r(n, t))))
              )
                return s;
            }
            return 0;
  ...
  const P = (e) => (null == e ? null : D(e)),
    ...
    G = (e) => "string" == typeof e && e.indexOf("<") > -1,
    U = (e, t) => {
        ...
        : (() => {
            ...
            if (t)
              ...
              var r,
                ...
                a =
                  null !=
                  (r = null == e || null == (l = e.value) ? void 0 : l.trim())
                    ? r
                    : "";
  ...
  class ce extends (function (e) {
    ...
    constructor(e, t) {
      ...
      var p;
      if (
        (Q(r, n.wrapperClass, d, u),
        Q(l, n.controlClass),
        z(r, l),
        Q(a, n.dropdownClass, u),
        n.copyClassesToDropdown && Q(a, d),
        Q(c, n.dropdownContentClass),
        z(a, c),
    ...
    setup() {
      ...
      if (
        ...
        (o.style.minWidth = a.style.minWidth),
        (o.style.maxWidth = a.style.maxWidth),
      ...
      ((null === t.maxItems || t.maxItems > 1) &&
        e.is_select_tag &&
        ie(a, { multiple: "multiple" }),
        t.placeholder && ie(i, { placeholder: t.placeholder }),
        !t.splitOn &&
          t.delimiter &&
          (t.splitOn = new RegExp("\\s*" + r(t.delimiter) + "+\\s*")),
        t.load && t.loadThrottle && (t.load = V(t.load, t.loadThrottle)),
        q(s, "mousemove", () => {
          e.ignoreHover = !1;
        }),
        q(
        ...
        q(l, "click", (t) => {
          ...
          s && e.onItemSelect(t, s)
            ? j(t, !0)
            : "" == i.value && (e.onClick(), j(t, !0));
        }),
        q(c, "keydown", (t) => e.onKeyDown(t)),
        q(i, "keypress", (t) => e.onKeyPress(t)),
        q(i, "input", (t) => e.onInput(t)),
        q(c, "blur", (t) => e.onBlur(t)),
        q(c, "focus", (t) => e.onFocus(t)),
        q(i, "paste", (t) => e.onPaste(t)));
      const m = (t) => {
      ...
      (q(a, "invalid", O),
        q(document, "mousedown", m),
        q(window, "scroll", v, d),
        q(window, "resize", v, d),
        (this._destroy = () => {
          (a.removeEventListener("invalid", O),
        ...
        Q(a, "tomselected", "ts-hidden-accessible"),
    ...
    onKeyDown(e) {
      ...
      if (((t.ignoreHover = !0), t.isLocked)) 9 !== e.keyCode && j(e);
        ...
        switch (e.keyCode) {
          case 65:
            if (R(oe, e) && "" == t.control_input.value)
              return (j(e), void t.selectAll());
            break;
          case 27:
            return (
              t.isOpen && (j(e, !0), t.close()),
          ...
          case 13:
            return void (t.canSelect(t.activeOption)
              ? (t.onOptionSelect(e, t.activeOption), j(e))
          ...
          case 9:
            return void (
              ...
              (t.canSelect(t.activeOption)
                ? (t.onOptionSelect(e, t.activeOption), j(e))
                : t.settings.create && t.createItem() && j(e))
            );
          case 8:
          case 46:
        ...
        (t.classList.contains("create")
          ? s.createItem(null, () => {
              s.settings.closeAfterSelect
                ? s.close()
                : s.settings.clearAfterSelect && s.setTextboxValue();
            })
          : void 0 !== (i = t.dataset.value) &&
            ((s.isDropdownContentStale = s.settings.hideSelected),
            s.addItem(i),
            s.settings.closeAfterSelect
              ? s.close()
              : s.settings.clearAfterSelect && s.setTextboxValue(),
    ...
    loadCallback(e, t) {
      ...
      ((i.loading = Math.max(i.loading - 1, 0)),
        (i.isDropdownContentStale = !0),
        i.clearActiveOption(),
        i.setupOptions(e, t),
        i.refreshOptions(i.isFocused && !i.isInputHidden),
        i.loading || J(i.wrapper, i.settings.loadingClass),
        i.trigger("load", e, t));
    }
    preload() {
    ...
    setActiveItem(e, t) {
      ...
      if ("single" !== a.settings.mode) {
        ...
        if (
          ...
          ("click" === i && R(oe, t)) || ("keydown" === i && R("shiftKey", t))
    ...
    clearActiveOption() {
      (this.activeOption &&
        (J(this.activeOption, "active"),
        ie(this.activeOption, { "aria-selected": null })),
        (this.activeOption = null),
        ie(this.focus_node, { "aria-activedescendant": null }));
    }
    selectAll() {
      const e = this;
    ...
    inputState() {
      ...
      e.control.contains(e.control_input) &&
        (ie(e.control_input, { placeholder: e.settings.placeholder }),
        ...
        (!e.isFocused && e.settings.hidePlaceholder && e.items.length > 0)
          ...
          : (e.settings.hidePlaceholder &&
              e.items.length > 0 &&
              ie(e.control_input, { placeholder: "" }),
            (e.isInputHidden = !1)),
    ...
    focus() {
      ...
      e.ignoreFocus = !0;
      const t = this.control_input.offsetWidth
        ? this.control_input
        : this.focus_node;
      (t.focus(),
        setTimeout(() => {
    ...
    search(e) {
      ...
      return (
        s.isDropdownContentStale || e !== s.lastQuery
          ? ((s.lastQuery = e),
            /(.)\1{15,}/.test(e) && (e = ""),
    ...
    refreshOptions(e = !0) {
      ...
      for (t = 0; t < n; t++) {
        ...
        for (
          ...
          if (
            void 0 === t &&
            "function" == typeof h.settings.optionGroupRegister
          )
            (w = h.settings.optionGroupRegister.apply(h, [o])) &&
              h.registerOptionGroup(w);
          ((t = h.optgroups[o]), void 0 === t ? (o = "") : (e = t.$order));
          const [s, a] = b(o, e);
          (i > 0 &&
            ((d = d.cloneNode(!0)),
            ie(d, { id: l.$id + "-clone-" + i, "aria-selected": null }),
      ...
      (h.settings.lockOptgroupOrder && p.sort((e, t) => e.order - t.order),
        ...
        (y.innerHTML = ""),
        z(y, l),
        (h.isDropdownContentStale = !1),
        h.settings.highlight &&
          ((S = y.querySelectorAll("span.highlight")),
    ...
    addOption(e, t = !1) {
      ...
      return null === s || i.options.hasOwnProperty(s)
        ? (i.updateOption(e[i.settings.valueField], e), !1)
    ...
    updateOption(e, t) {
      ...
      (c &&
        ...
        (s = i._render("item", t)),
        c.classList.contains("active") && Q(s, "active"),
        se(c, s)),
        (i.isDropdownContentStale = !0));
    }
    removeOption(e, t) {
      ...
      $(this, t ? [] : ["change", "dropdown_close"], () => {
        ...
        if (
          ...
          if (
            ...
            (n.settings.clearAfterSelect && n.setTextboxValue(),
              n.isPending ||
    ...
    updateOriginalInput(e = {}) {
      ...
      if (t.is_select_tag) {
        ...
        function l(e, i, s) {
          return (
            e || (e = K('<option value="' + N(i) + '">' + N(s) + "</option>")),
    ...
    open() {
      ...
      e.isLocked ||
        ...
        ((e.isOpen = !0),
        ie(e.focus_node, { "aria-expanded": "true" }),
        e.refreshState(),
        W(e.dropdown, { visibility: "hidden", display: "block" }),
        e.positionDropdown(),
        W(e.dropdown, { visibility: "visible", display: "block" }),
        e.focus(),
    ...
    close(e = !0) {
      ...
      (e &&
        ...
        (t.isOpen = !1),
        ie(t.focus_node, { "aria-expanded": "false" }),
        W(t.dropdown, { display: "none" }),
    ...
    deleteSelection(e) {
      ...
      for (j(e, !0), void 0 !== s && r.setCaret(s); l.length; )
        r.removeItem(l.pop());
    ...
    shouldDelete(e, t) {
      ...
      return !(
        ...
        ("function" == typeof this.settings.onDelete &&
          !1 === this.settings.onDelete.call(this, i, t))
      );
    }
      ...
      if (
        ...
        "option" === e || "option_create" === e
          ? t[n.settings.disabledField]
            ? ie(s, { "aria-disabled": "true" })
            : ie(s, { "data-selectable": "" })
          : "optgroup" === e &&
        ...
        (ie(s, { "data-value": i }),
          "item" === e
            ? (Q(s, n.settings.itemClass), ie(s, { "data-ts-item": "" }))
            : (Q(s, n.settings.optionClass),
  ...
  return (
        ...
        i = Object.assign(
          {
            ...
            tabindex: 0,
            html: (e) =>
              `<div class="${e.className}" title="${e.title}" role="${e.role}" tabindex="${e.tabindex}">&times;</div>`,
          },
          e,
        );
      t.on("initialize", () => {
    ...
    ce.define("dropdown_input", function () {
      ...
      ((e.settings.shouldOpen = !0),
        e.hook("before", "setup", () => {
          ...
          const n =
            null == (t = e.input) ? void 0 : t.getAttribute("aria-label");
        ...
        e.on("initialize", () => {
          ...
          (e.hook("instead", "onBlur", (i) => {
            ...
            q(e.control_input, "blur", () => e.onBlur()),
            e.hook("before", "close", () => {
    ...
    ce.define("optgroup_columns", function () {
      ...
      e.hook("instead", "onKeyDown", (i) => {
        ...
        ((e.ignoreHover = !0),
          ...
          (s = te(e.activeOption, "[data-selectable]")),
          r &&
    ...
    ce.define("virtual_scroll", function () {
      ...
      const u = (t) =>
        ...
        p = (t, i) => e.items.indexOf(i) >= 0 || c.indexOf(i) >= 0;
      ((e.setNextUrl = (e, t) => {
        l[e] = t;
      }),
        (e.getUrl = (t) => {
        ...
        e.hook("instead", "canLoad", (i) => (i in l ? u(i) : t.call(e, i))),
        e.hook("instead", "loadCallback", (t, i) => {
          ...
          (s.call(e, t, i),
            a ||
              ...
              ((d = !0),
              "" === e.lastValue &&
                ((c = Object.keys(e.options)), (r = l[""]))),
            (a = !1));
        }),
        e.hook("before", "refreshOptions", () => {
          e.activeOption &&
            "option" !== e.activeOption.getAttribute("role") &&
            e.setActiveOption(e.activeOption.previousElementSibling);
        }),
      ...
      const h = () => {
        d && (e.clearOptions(p), r && (l[""] = r));
      };
      (e.on("type", (t) => {
        "" === t && (h(), e.refreshOptions(!1));
      }),
        e.on("dropdown_close", h),
        e.on("initialize", () => {
          ((c = Object.keys(e.options)),
            (n = e.dropdown_content),
            ...
            n.addEventListener("scroll", () => {
              e.settings.shouldLoadMore.call(e) &&
                u(e.lastValue) &&
                (a || ((a = !0), e.load.call(e, e.lastValue)));
            }));
        }));
    }),
    ce
